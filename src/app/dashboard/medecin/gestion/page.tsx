      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex items-end justify-between">
          <div className="space-y-1">
            <h2 className="text-xl font-bold text-slate-900 tracking-tight">Gestion Administrative</h2>
            <p className="text-[13px] text-slate-500 font-medium">Facturation, reçus et suivi des honoraires</p>
          </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Card className="border-slate-100 shadow-sm bg-white">
            <CardContent className="p-5">
              ...
              <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Recettes du Jour</p>
          ...
          <Card className="border-slate-100 shadow-sm bg-white">
            <CardContent className="p-5">
              ...
              <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Factures Impayées</p>
          ...
          <Card className="border-slate-100 shadow-sm bg-white">
            <CardContent className="p-5">
              ...
              <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Mode de Paiement Préféré</p>
              <p className="text-2xl font-bold text-slate-900 mt-1">C.B.</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="border-slate-100 shadow-sm bg-white overflow-hidden">
          <CardHeader className="border-b border-slate-50 py-4 px-6 bg-slate-50/30 flex-row items-center justify-between">
            <CardTitle className="text-[12px] font-bold uppercase tracking-widest text-slate-900">Dernières Factures</CardTitle>
            <div className="flex items-center gap-2">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-slate-50 bg-slate-50/10">
                  <th className="px-6 py-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest">ID Facture</th>
