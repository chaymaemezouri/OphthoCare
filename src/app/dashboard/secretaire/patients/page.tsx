      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex items-end justify-between">
          <div className="space-y-1">
            ...
            <p className="text-[13px] text-slate-500 font-medium">Gestion administrative des dossiers patients</p>
          </div>
            ...
            <Table>
              <TableHeader className="bg-slate-50/50">
                <TableRow className="hover:bg-transparent border-slate-100">
                  ...
                  <TableHead className="font-bold text-slate-400 uppercase text-[10px] tracking-widest">Statut Administratif</TableHead>
